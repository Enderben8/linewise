...
| "Linewise is open in another tab"                                                          | Expected: only one page at a time may hold the web database. Close the other tab or window and press Reload. A page that replaces another reloads itself once, so this should only appear when a second tab really is open.                                                                                                                                                 |
